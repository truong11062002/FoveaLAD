...
teacher_ckpt = 'https://download.openmmlab.com/mmdetection/v2.0/foveabox/fovea_align_r101_fpn_gn-head_mstrain_640-800_4x4_2x_coco/fovea_align_r101_fpn_gn-head_mstrain_640-800_4x4_2x_coco_20200208-649c5eb6.pth'
model = dict(
    type='LAD',
    backbone=dict(
        type='ResNet',
...
work_dir = './data/Truong_Hai/work_dirs/lad_r50_fovea_align_r101_fpn_coco_1x'
auto_resume = False
gpu_ids = [0]
