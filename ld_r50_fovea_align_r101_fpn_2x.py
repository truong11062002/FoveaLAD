...
teacher_ckpt = 'data/Truong_Hai/work_dirs/fovea_align_r101_fpn_gn-head_mstrain_640-800_4x4/best_bbox_mAP_epoch_24.pth'
model = dict(
    type='KnowledgeDistillationSingleStageDetector',
    teacher_config='data/Truong_Hai/teacher_cfg/fovea_align_r101_fpn_gn-head_mstrain_640-800_4x4.py',
    teacher_ckpt = 'data/Truong_Hai/work_dirs/fovea_align_r101_fpn_gn-head_mstrain_640-800_4x4/best_bbox_mAP_epoch_24.pth',
    ...
    test_cfg=dict(
        ...
        max_per_img=100))
work_dir = './data/Truong_Hai/work_dirs/ld_r50_fovea_align_r101_fpn_2x'
auto_resume = False
gpu_ids = [0]