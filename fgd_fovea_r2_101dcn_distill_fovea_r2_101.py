...
distiller = dict(
    ...
    teacher_pretrained=
    '../mmdetection/data/Truong_Hai/fovea_pth/fovea_align_res2net_DCN_fpn_gn-head_mstrain_640-800_4x4_2x_dodv_ext/best_bbox_mAP_epoch_18.pth',
    init_student=True,
    distill_cfg=[
        dict(
...
student_cfg = '../mmdetection/data/Truong_Hai/student_cfg/fovea_align_res2net_fpn_gn-head_mstrain_640-800_4x4_2x_dodv_ext.py'
teacher_cfg = '../mmdetection/data/Truong_Hai/fovea_pth/fovea_align_res2net_DCN_fpn_gn-head_mstrain_640-800_4x4_2x_dodv_ext/fovea_align_res2net_DCN_fpn_gn-head_mstrain_640-800_4x4_2x_dodv_ext.py'
work_dir = '../mmdetection/data/Truong_Hai/work_dirs/fgd_fovea_r2_101dcn_distill_fovea_r2_101'
auto_resume = False
gpu_ids = range(0, 1)
