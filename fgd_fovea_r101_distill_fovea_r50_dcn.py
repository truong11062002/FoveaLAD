...
student_cfg = './data/Truong_Hai/student_cfg/fovea_align_r50_dcn_fpn_gn-head_mstrain_640-800_4x4.py'
teacher_cfg = './data/Truong_Hai/teacher_cfg/fovea_align_r101_fpn_gn-head_mstrain_640-800_4x4.py'
work_dir = './data/Truong_Hai/work_dirs/fgd_fovea_r101_distill_fovea_r50_dcn'
auto_resume = False
gpu_ids = range(0, 1)
